...
const STORAGE_KEY = 'medellin_empire_news';
const STORAGE_ID = 'medellin_empire_nextid';

const defaultNews = [
	{
		id: 1, emoji: '🔫', image: null, tag: 'Háború', tagColor: 'red', time: '12p',
	...
	{
		id: 2, emoji: '💰', image: null, tag: 'Üzlet', tagColor: '', time: '45p',
	...
	{
		id: 3, emoji: '🚔', image: null, tag: 'Hatóság', tagColor: 'blue', time: '2ó',
	...
	{
		id: 4, emoji: '🗺️', image: null, tag: 'Terület', tagColor: 'green', time: '4ó',
...
createApp({
	setup() {
		...
		// Auto-save whenever news changes
		watch(news, (val) => {
			try {
				localStorage.setItem(STORAGE_KEY, JSON.stringify(val));
			} catch (e) {
				console.warn('Mentés sikertelen (localStorage tele lehet):', e);
			}
		}, { deep: true });

		function saveNextId() {
			try { localStorage.setItem(STORAGE_ID, String(nextId)); } catch (e) { }
		}
